...
public class Polideportivo extends Edificio {
    ...
    public void calcularVolumen() {
        double volumenPolideportivo= ancho * largo * alto;
        System.out.println("El volumen del edificio es de " +volumenPolideportivo);
    }

    @Override
    public void calcularSuperficie() {
        double superficiePolideportivo = ancho * largo;
        System.out.println("La superficie del polideportivo es de " +superficiePolideportivo);
    }
